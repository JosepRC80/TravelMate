<x-app-layout>
    ...
    <x-slot name="header">
        <x-page-header title="Editar lloc" :back-route="route('trips.show', $trip)" :back-text="$trip->title">
            <x-slot:subtitle>
                Actualitza la informació, la categoria o la ubicació del lloc.
            </x-slot:subtitle>
        </x-page-header>
    </x-slot>
    ...
    @php
        $currentLatitude = old('latitude', $place->latitude);
        $currentLongitude = old('longitude', $place->longitude);

        $hasCoordinates =
            !is_null($currentLatitude) &&
            $currentLatitude !== '' &&
            !is_null($currentLongitude) &&
            $currentLongitude !== '';
    ...
    <div class="container py-4">
        ...
        <div class="form-card">
            ...
            <x-card>
                ...
                <div class="d-flex align-items-start gap-3 mb-4">
                    ...
                    <div>
                        ...
                        <p class="text-muted mb-0">
                            Modifica la informació del lloc dins del viatge
                ...
                <form action="{{ route('places.update', [$trip, $place]) }}" method="POST">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12 col-lg-7">
                                ...
                                <input type="text" name="name" id="name"
                                    ...
                                    value="{{ old('name', $place->name) }}" placeholder="Ex. Tokyo Tower" required
                                    autofocus>
                            ...
                            <div class="col-12 col-lg-5">
                                ...
                                <input type="text" name="country" id="country"
                                    ...
                                    value="{{ old('country', $place->country) }}" placeholder="Ex. Japó" required>

                                <div class="form-help mt-2">
                                    Indica el país on es troba aquest lloc.
                                </div>
                            ...
                            <div class="col-12">
                                ...
                                @if ($categories->isNotEmpty())
                                    ...
                                    <div class="form-help mt-2">
                                        Pots canviar la categoria actual per reorganitzar el lloc.
                                    </div>
                                ...
                                @else
                                    <div class="alert alert-warning category-warning mb-3">
                                        <div class="d-flex align-items-start gap-2">
                                            ...
                                            <div>
                                                <strong>
                                                    No tens cap categoria disponible.
                                                </strong>

                                                <div class="small mt-1">
                                                    Has de crear almenys una categoria abans de poder guardar els
                                                    canvis.
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="4" maxlength="550" placeholder="Informació, recomanacions o comentaris sobre el lloc...">{{ old('description', $place->description) }}</textarea>
                    ...
                    <div class="form-section">
                        ...
                        <div class="location-card">
                            ...
                            <div class="d-flex align-items-start gap-3 mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted small mb-0">
                                        Pots conservar les coordenades actuals o tornar a buscar la ubicació a partir
                                        del nom i el país.
                                    </p>
                                </div>
                            ...
                            <div id="location-result"
                                ...
                                <p id="location-display-name" class="text-muted small mb-3">
                                    @if ($hasCoordinates)
                                        Coordenades:
                                        {{ $currentLatitude }},
                                        {{ $currentLongitude }}
                                ...
                                <a id="open-osm-link" href="{{ $openStreetMapUrl }}" target="_blank"
                    ...
                    <div class="form-section">
                        ...
                        <div class="d-flex align-items-start gap-2 mb-3">
                            ...
                            <div>
                                ...
                                <p class="form-help mb-0">
                                    Pots conservar-les, modificar-les manualment o tornar a calcular-les amb la cerca.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="coordinates-box">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" step="any" name="latitude" id="latitude"
                                        ...
                                        value="{{ $currentLatitude }}" placeholder="Ex. 35.6586">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" step="any" name="longitude" id="longitude"
                                        ...
                                        value="{{ $currentLongitude }}" placeholder="Ex. 139.7454">
                            ...
                            <div class="form-help mt-3">
                                ...
                                Les coordenades són opcionals. Si elimines un dels dos valors, comprova també l’altre
                                abans de guardar.
                            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const locationDisplayName =
                document.getElementById('location-display-name');

            const openOsmLink =
                document.getElementById('open-osm-link');
            ...
            `;
                ...
                try {
                    ...
                    showMessage(
                        'Ubicació actualitzada. Les coordenades s’han modificat automàticament.',
                        'success'
                    );
                } catch (error) {
                    console.error(
                        'Error en buscar la ubicació:',
                        error
                    );
